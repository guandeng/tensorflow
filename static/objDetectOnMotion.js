...
const apiServer = s.getAttribute("data-apiServer") || window.location.origin + '/check'; //the full TensorFlow Object Detection API server url
...
function drawBoxes(objects) {
    ...
    objects.filter(object => object.class_name).forEach(object => {
        ...
        let x = object.x1 * drawCanvas.width;
        let y = object.y1 * drawCanvas.height;
        let width = (object.x2 * drawCanvas.width) - x;
        let height = (object.y2 * drawCanvas.height) - y;
